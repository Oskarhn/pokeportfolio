-- P28 restates the complete privilege baseline (SECURITY.md §5.9). This milestone adds no tables
-- and exactly one browser-reachable function: reduce_holding_quantity(uuid, jsonb), the
-- Holding Detail quantity-correction surface (20260831120000). Everything else below is identical
-- to `20260830120050_m12_privilege_baseline.sql`; only the P28 addition is noted inline.
